        ...
        Pass 
        {
            ...
            CGPROGRAM
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    float ToonRange = Toon(normalDirection, lightDirection);
                    ...
                    else
                    {
                        ...
                        specularReflection = round(specularReflection * _Stripes/ _Stripes);
                    }

                    float3 color = floor(ToonRange/detail) * (ambientLighting + diffuseReflection) * tex2D(_Tex, i.uv) + specularReflection; //Texture is not applient on specularReflection
